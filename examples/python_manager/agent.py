...
from prompts import SIMPLE_FILE_CREATION_PROMPT, PYTHON_PROJECT_PROMPT
...
if __name__ == "__main__":
    ...
    for i in range(100):
        ...
        agent.generate_chat_log(
            chain_messages,
            print_chat=True,
            save_log=f"traces/python_project2/{name}.log",
        )
        agent.save_trace(f"traces/python_project2/{name}.trace")
