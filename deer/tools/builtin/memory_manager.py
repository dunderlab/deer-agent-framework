...
class MemoryManager(ToolProvider):
    ...
    @tool()
    def store_key_insight(self, key: str, value: Any) -> Return(success=bool, message=str):
    ...
    @tool()
    def retrieve_key_insight(self, key: str) -> Return(value=Any, exists=bool, message=str):
